...
class FcwlopTransactionLogListController extends AdminListController
{
     ...
     * @var string
     */
    protected $_sListClass = FcwlopTransactionLog::class;
     ...
     * @var string
     */
    protected $_sThisTemplate = '@fcwlop/admin/fcwlop_transactionlog_list';
