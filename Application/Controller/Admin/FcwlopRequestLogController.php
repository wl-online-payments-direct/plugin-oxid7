...
class FcwlopRequestLogController extends AdminDetailsController
{
     ...
     * @var string
     */
    protected $_sThisTemplate = '@fcwlop/admin/fcwlop_requestlog';
    ...
    public function render(): string
    {
        ...
        $oLogEntry = oxNew(FcwlopRequestLog::class);
